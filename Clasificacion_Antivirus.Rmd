...
A continuación voy a aplicar es FCA y sacara la representación del plot de fca en un mapa de calor, usando las funciones de plot_interactivo, plot_dendograma y plot_dendograma_interactivo. Obtenemos un total de 24 conceptos irreducibles que serían los grupos de antivirus que hay y 75 implicaciones irreducibles que se corresponderían a los grupos de archivos con resultados distintos.
...
matriz_descompuesta <- as.matrix(t(fc_detected[["I"]]))
